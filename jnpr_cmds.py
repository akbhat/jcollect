...
qfx5100_cmds_shell_D = ["rtinfo -rnV",
                        ...
                        #"""cli -c 'show route forwarding-table | match Push | no-more'""",  #redundant?


qfx10002_cmds_shell_Q = ["""cprod -A fpc0 -c 'show nhdb all'""",
                         """cli -c 'show chassis pfchip interrupt-errors pfchip-id 0 | no-more'""", 
                         """cli -c 'show chassis pfchip total pfchip-id 1 | no-more'""",
                         """cli -c 'show chassis pfchip rates pfchip-id 1 | no-more'""",
                         """cli -c 'show chassis pfchip parity-errors pfchip-id 1 | no-more'""",
                         """cli -c 'show chassis pfchip link-errors pfchip-id 1 | no-more'""",
                         """cli -c 'show chassis pfchip vital-errors pfchip-id 1 | no-more'""",
                         """cli -c 'show chassis pfchip link-errors pfchip-id 0 | no-more'""",
                         """cli -c 'show chassis pfchip total pfchip-id 0 summary | no-more'""",
                         """cli -c 'show chassis pfchip link-errors pfchip-id 1 | no-more'""",
                         """cli -c 'show chassis pfchip total pfchip-id 1 summary | no-more'""",
                         ...
                         """cli -c 'show ethernet-switching table | no-more'""",
                         """cli -c 'show multicast route | no-more'""",
                         """cli -c 'show multicast route extensive | no-more'""",
                         """cli -c 'show igmp group | no-more'""",
                         """cli -c 'show pim join | no-more'""",
                         """cli -c 'show pim join extensive | no-more'""",
                         """cli -c 'show route forwarding-table multicast extensive | no-more'""",
                         ...
                         """cli -c 'show route forwarding-table | no-more'""",
                         """cli -c 'show route forwarding-table summary | no-more'""",
                         """cli -c 'show route forwarding-table | match Push | no-more'""",
                         """cli -c 'show ldp session extensive | no-more'""",
                         """cli -c 'show ldp database extensive | no-more'""",
                         """cli -c 'show pfe statistics traffic | no-more'""",
...
qfx5100_vxlan_cmds_shell_Q = ["""cli -c 'show ethernet-switching vxlan-tunnel-end-point source | no-more'""",
                              ...
                              """cprod -A fpc0 -c 'sh shim virtual error-counters'""",
                              """cprod -A fpc0 -c 'sh shim virtual bridge-domain'""",
                              """cprod -A fpc0 -c 'sh shim virtual network_ifd_to_egress_mapping'""",
                              """cprod -A fpc0 -c 'sh l2 manager vnid'""",
                              """cprod -A fpc0 -c 'set dc bc "show c"'"""]
                       	      #"""cli -c 'show pfe statistics traffic | no-more'""",
 
qfx5100_vxlan_cmds_shell_D = []
